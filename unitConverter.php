...
<html lang="en">
    ...
    <title><?php echo $lang['NAVRBAR_CONVERTER']; ?></title>
    ...
    <link rel="stylesheet" href="/resources/css/unitConverter.css">
...
<body class="home">
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        ...
        <span class="mdl-layout-title"><?php echo $lang['NAVRBAR_CONVERTER']; ?></span>
          <div class="mdl-layout-spacer"></div>
           <a id="flag" href="unitConverter.php?select-language" class="dropdown-toggle" data-toggle="dropdown"><i style="list-style: none;" class="fa fa-globe fa-2x"></i></a>
                            
                                <ul class="dropdown-menu dropdown-menu-flag" role="menu">
                                  <li>
                                        <a href="unitConverter.php?lang=ro">
                                            <img src="http://www.country-dialing-codes.net/img/png-country-4x2-flat-res-640x480/ro.png" alt="Romana" width="28px" height="18px">
                                            <span>Romana</span>
                                        </a>
                                  </li>
                                  <li>
                                        <a href="unitConverter.php?lang=en">
...
converter_cat = 62;
converter_size = 3;
converter_color_border = "#888888";
converter_color_title = "#6d3a1b";
converter_color_titlebg = "#6d3a1b";
converter_color_text = "black";
converter_color_bg = "white";
</script>
